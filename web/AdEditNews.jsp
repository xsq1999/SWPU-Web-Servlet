...
<body>
<form action="AdSaveNewsServlet" method="post">

    <a style="font-size: 20px;margin-left: 210px;">ID  </a><input type="text" class="txs" style="margin-left: 42px;" name="newsID" value="${news.newsID}" />
    <a style="font-size: 20px;margin-left: 85px;">作者</a><input type="text" class="txs" name="newsWriter" value="${news.newsWriter}" /><br><br>
    <a style="font-size: 20px;margin-left: 210px;">时间</a><input type="text" class="txs" name="newsDate" value="${news.newsDate}" />
    <a style="font-size: 20px;margin-left: 85px;">类型</a><input type="text" class="txs" name="newsCon" value="${news.newsCon}" /><br><br>
    <a style="font-size: 20px;margin-left: 210px;">news</a><input type="text" class="tx" name="newsTitle" value="${news.newsTitle}" /><br><br>

    <textarea id="newsDetail" name="newsDetail" style="width: 1100px; height: 400px; margin: 0 auto;" > </textarea><br>

    <input style="border:solid 1px #0c89ff; background:#0c89ff; color:#fff;margin-left: 210px;margin-bottom: 120px;" type="submit" value="更新" />
</form>
